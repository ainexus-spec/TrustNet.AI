                ...
                children: [
                  ...
                  _profileTile(
                    ...
                    () async {
                      ...
                      debugPrint("User after logout: ${FirebaseAuth.instance.currentUser}");
                      // GoRouter's refreshListenable detects the auth change
                      // and automatically redirects to '/' (AuthWrapper → login screen).
